    ...
    return {
        ...
        execute: function() {
            FormAlunoComponent = (function () {
                function FormAlunoComponent(formBuilder) {
                    this.sucesso = false;
                ...
                FormAlunoComponent.prototype.validarForm = function (formBuilder) {
                    this.alunoForm = formBuilder.group({
                        nome: ['', common_1.Validators.required],
                        email: ['', common_1.Validators.compose([
                                common_1.Validators.required,
                                email_validator_1.EmailValidator.validate //validador customizado para validar email
                            ])],
                        curso: ['', common_1.Validators.required]
                    });
                };
                FormAlunoComponent.prototype.temErros = function () {
                    var erros = false;
