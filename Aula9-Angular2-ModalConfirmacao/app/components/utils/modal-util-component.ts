...
//input -> permite passar parametros de um component para o outro
//output -> faz a ligacao dos dois components
//EventEmitter -> observer-> permite detectar os eventos de um component para outro
  @Input() id: string;
  @Input() titulo: string;
